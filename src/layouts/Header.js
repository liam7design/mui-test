...
import { AppBar, Toolbar, IconButton, Typography, Drawer, MenuList, MenuItem, ListItemText, Grid, useScrollTrigger, Slide } from '@mui/material';
...
// 스크롤 시 AppBar를 숨기거나 보이게 하는 컴포넌트
function HideOnScroll({ children }) {
  const trigger = useScrollTrigger(); // 스크롤 트리거 감지
...
const Header = ({ title, showBackButton = false, showCloseButton = false, enableDrawer = false }) => {
  ...
  return (
    <>
      {/* HideOnScroll 컴포넌트로 AppBar 감추기/보이기 설정 */}
      <HideOnScroll>
        {/* AppBar 설정 */}
        <AppBar>
          <Toolbar>
